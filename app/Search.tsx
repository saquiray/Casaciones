...
export default function Search() {
    ...
    <View style={styles.documentCard}>
      ...
      <View style={styles.actionsContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            sharePDF(`http://143.244.163.112:3000${item.url}`, item.name)
          }
        >
  ...
  return (
    <View style={styles.container}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  setSelectedMonth(selectedMonth === item ? "" : item)
                }
              >
                <Text
                  style={[
                    styles.filterChipText,
                    selectedMonth === item && styles.filterChipTextActive,
                  ]}
                >
                  {item}
                </Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                ...
                onPress={() =>
                  setSelectedYear(selectedYear === item ? "" : item)
                }
              >
                <Text
                  style={[
                    styles.filterChipText,
                    selectedYear === item && styles.filterChipTextActive,
                  ]}
                >
                  {item}
                </Text>
      ...
      {/* �📊 Resultados */}
      <Text style={styles.resultsLabel}>Resultados ({documents.length})</Text>
